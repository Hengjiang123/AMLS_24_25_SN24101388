...
from A.RandomForest import rf_train_gridsearch
...
def main():
    ...
    train_images_svm_rf = preprocess_SVM_RF(train_images) 

    # test output SVM    
    svm_model, svm_best_C, svm_cv_acc = svm_train_gridsearch(train_images_svm_rf, train_labels)
    print("Best C:", svm_best_C, "SVM_acc:", svm_cv_acc)

    # test output rf
    rf_model, rf_best_params, rf_cv_acc = rf_train_gridsearch(train_images_svm_rf, train_labels)
